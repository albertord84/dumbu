...
$curl = "curl 'https://www.instagram.com/accounts/login/ajax/' -H 'cookie: mid=Wh8j7wAEAAFI8PVD2LfNQan_fx9D; ig_notifications_dismiss=1514734509928; ig_or=portrait-primary; ig_vw=432; ig_pr=2; ig_vh=591; csrftoken=S6TMNqHjYPh9o8r68pFs8sBfR10KU5ff; rur=FTW; urlgen=\"{\\\"time\\\": 1513524885\054 \\\"152.207.249.49\\\": 27725}:1eQcI5:t3dXIWI9ovy3RUbCg3w1G8bZdH8\"' -H 'origin: https://www.instagram.com' -H 'accept-encoding: gzip, deflate, br' -H 'accept-language: en-US,en;q=0.8' -H 'user-agent: Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Mobile Safari/537.36' -H 'x-requested-with: XMLHttpRequest' -H 'x-csrftoken: S6TMNqHjYPh9o8r68pFs8sBfR10KU5ff' -H 'x-instagram-ajax: 1' -H 'content-type: application/x-www-form-urlencoded' -H 'accept: */*' -H 'referer: https://www.instagram.com/' -H 'authority: www.instagram.com' --data 'username=riveauxmerino&password=Notredame88' --compressed";
$res = $Robot->set_client_cookies_by_curl(19546, $curl,$robot_id = NULL );
var_dump($res);
//

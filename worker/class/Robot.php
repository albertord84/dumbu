        ...
        public function do_follow_unfollow_work($Followeds_to_unfollow, $daily_work) {
            ...
            for ($i = 0; $i < $GLOBALS['sistem_config']->REQUESTS_AT_SAME_TIME && ($has_next); $i++) {
                ...
                {                    
                    ...
                    $this->DB->InsertEventToWashdog($daily_work->client_id, washdog_type::ROBOT_VERIFY_ACCOUNT, 1, $this->id);
                    $error = TRUE;
                }
        ...
        public function get_profiles_to_follow($daily_work, &$error, &$page_info) {
            ...
            if ($daily_work->rp_type == 0) {
                ...
                if($json_response === NULL)
                {
                    ...
                    $this->DB->InsertEventToWashdog($daily_work->users_id, washdog_type::ROBOT_VERIFY_ACCOUNT, 1, $this->id);

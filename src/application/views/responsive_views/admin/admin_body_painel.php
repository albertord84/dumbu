            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="center filters">
                        ...
                        <select id="credit_card_xpeiration_year" class="form-control" disabled="true">
                            <option>--TODOS--</option>
                        ...
                        for($i=0;$i<$num_rows;$i++){
                            ...
                            echo '<tr id="row-client-'.$result[$i]['id'].'" style="visibility: visible;display: block">';
                                ...
                                echo '<td style="width:240px; padding:5px">';
                                    ...
                                    echo '<b>Login: </b>'.$result[$i]['login'].'<br>';
                                    echo '<b>Password: </b>'.$result[$i]['pass'].'<br>';
                                    echo '<b>Email: </b>'.$result[$i]['email'].'<br><br>';
                                    echo '<b>Status: </b>'.get_name_status($result[$i]['status_id']).'<br>';

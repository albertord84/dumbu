                        ...
                        for($i=0;$i<$num_rows;$i++){
                            ...
                            echo '">';
                                ...
                                if($result[$i]['order_key'])
                                    ...
                                    echo '<button style="width:160px" type="button" id="client_'.$result[$i]['user_id'].'" class="btn btn-success ladda-button clean-cookies" data-style="expand-left" data-spinner-color="#ffffff"> <span class="ladda-label">Limpar cookies</span></button><br><br>';
                                echo '</td>';
                            echo '</tr>';

...
<div class="row">
    ...
    <div class="col-xs-6" >
        <div class="alert alert-danger" role="alert" style="text-align:justify">
            ...
            uma parte desses usuários o seguirão de volta e após um determinado tempo deixaremos
            de seguir esses usuários.  Adicione seus perfis de referência aqui:
        </div>
    </div>
    <div class="col-xs-3" ></div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-6" >
        <div class="alert alert-danger" role="alert" style="text-align:justify">
             Dica: Lembre-se que para garantir um bom desempenho da ferramenta você deve

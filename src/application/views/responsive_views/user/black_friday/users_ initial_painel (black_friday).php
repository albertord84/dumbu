...
<div class="row">
    ...
    <div class="col-xs-4">
        <div class="row"><img width="85%" style="margin-top:10%; margin-left:-27%" src="<?php echo base_url().'assets/img/black-friday/ghne_cinco_mil.png'?>"/>  </div>
        <div class="row"><img width="55%" style="margin-top:3%; margin-left:-27%"  src="<?php echo base_url().'assets/img/precio.png'?>"/></div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-4">
        <div class="center" style="width:100%">
            <a href="#lnk_sign_in_now" class="promotional_btn">

...
<div style="position:absolute; background-color:#FAFAFA; width:100%; height:100%;">
        <div style="position:absolute; top:8%; left:20%; width:60%; height:7%; color:black; text-align:center;">
            <b style="font-family:sans-serif;font-size:18px">ATUALIZAR DADOS</b>
        </div>
        <div style="box-shadow:0px 0px 5px 0px #424242; border-radius:5px;position:absolute; top:16%; left:30%; width:40%; height:70%; border:1px solid gray;">            

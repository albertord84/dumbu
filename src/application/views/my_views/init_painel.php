    ...
    <div id="bottom_left_painel" style="position:absolute; top:0%; height:100%; left:0%; width:30%;">
        <div style="position:absolute; top:10%; height:100%; left:20%; width:80%;">
            <p style="position: absolute; top:0%;  left:5%;color: white; font-family: sans-serif;">
                ...
                <b style="font-size: 18px">1. Escolha perfis que deseja captar seguidores</b><br><br>
                <b style="font-size: 18px">2. A ferramenta seguirá automáticamente os seguidores dos perfis escolhidos</b><br><br>
                <b style="font-size: 18px">3. Uma parte dos usuários seguirá você de volta</b><br><br>
                <b style="font-size: 18px">4. Em 48h a ferramenta deixará de seguir esses perfis automáticamente </b><br><br>
            </p>
        </div>
    </div>

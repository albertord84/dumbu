...
//        var_dump($datas1);
        ...
        if($this->user_model->set_sesion($user[0]['id'], $this->session, '')){
            ...
            $data['content_header'] = $this->load->view('responsive_views/admin_header_painel','', true);
            $data['content'] = $this->load->view('responsive_views/admin_body_painel',$result, true);
            $data['content_footer'] = $this->load->view('responsive_views/admin_footer_painel', '', true);

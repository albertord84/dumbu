$(document).ready(function(){     
    ...
    $("#btn_credit_card_data_update").click(function() {
    ...
    $("#btn_register_end_update").click(function() {        
        $.ajax({
            url : base_url+'index.php/welcome/client_update',
            data : {
            ...
            success : function(response) {
                if(response['success']){
                    alert('Usuario atualizado corretamente');
    ...
    $("#btn_register_cancel_update").click(function() {
        $(location).attr('href',base_url+'index.php/welcome/panel_client');
    });
